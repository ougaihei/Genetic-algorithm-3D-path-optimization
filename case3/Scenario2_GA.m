...
UPPER_LIMIT=5000;% range for random generation of unknowns
LOWER_LIMIT=-5000;
popSize=500;%population size
offspSize=2;%offspring size
n=4;
tau=1/sqrt(2*sqrt(n));%learning rate for step size
sigma=1;%variance for normal distribution
