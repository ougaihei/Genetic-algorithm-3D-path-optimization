...
for i=1:popSize
    ...
    [population(i).alpha population(i).theta population(i).x population(i).y population(i).z population(i).fitness population(i).error_tvd]=trajGenerate2(TARGET_ALPHA,TARGET_THETA,TARGET_TVD,ds,lambda,C);
...
while(Gen<=500)
    ...
    [offspring1.alpha offspring1.theta offspring1.x offspring1.y offspring1.z offspring1.fitness offspring1.error_tvd]=trajGenerate2(TARGET_ALPHA,TARGET_THETA,TARGET_TVD,ds,offspring1.lambda,offspring1.C);
    [offspring2.alpha offspring2.theta offspring2.x offspring2.y offspring2.z offspring2.fitness offspring1.error_tvd]=trajGenerate2(TARGET_ALPHA,TARGET_THETA,TARGET_TVD,ds,offspring2.lambda,offspring2.C);
    ...
    sigmas(Gen,:)=[population(1).sigma_lambda population(1).sigma_C];
